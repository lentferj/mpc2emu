...
## An MS-20 bass patch  — `FEATUREDEMO_02.E4B [03]`
...
(`models/common.py`).  Verified: that patch now converts to **2.005 Hz** (was
...
|---------:|---------------:|:---------------------:|-------|
| 0.000 | 0.08 | **0.02**  | a bass patch (Triangle) |
| 0.200 | ~0.6 | **0.13**  | a bass patch (Sine) |
| 0.350 | ~1.7 | **0.50**  | a bass patch (Sine) |
| 0.500 | 4.12 | **2.00**  | a pad (Sine) — matches the MS-20 bass patch (sync'd) |
| 0.650 | ~8   | **7.96**  | a bass patch (SawDown) |
| 0.760 | ~13  | **21.93** | a lead patch (SawUp) |
