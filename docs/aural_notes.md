...
## Bass-MS20 Antima-Patch  — `FEATUREDEMO_02.E4B [03]`  (src: `Bass-MS20 Antima-Patch 2c.xpm`)
...
(`models/common.py`).  Verified: Bass-MS20 Antima 2c now converts to **2.005 Hz** (was
...
| 0.500 | 4.12 | **2.00**  | 11 OB Thick Pad.xpm (Sine) — matches Bass-MS20 Antima -Patch 2c (sync'd) |
